...
if __name__ == "__main__":
    ...
    # Compute each slot width based on the split factor
    T = 5/mu
    slotWidths = splitFactors * T

    # Compute throughput for each split factor value
    throughput = arrivalRate * np.log(mu / arrivalRate)
    throughput = splitFactors * throughput
